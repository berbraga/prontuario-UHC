...
// Composables
import { createRouter, createWebHistory } from "vue-router";
import {auth, db, docs, getDocs} from '@/store/firebase'
    ...
    return auth.onAuthStateChanged(async (currentUser) => {
      ...
      if (currentUser) {
        ...
        // window.errorHandler.setUser(`${currentUser.uid} (${currentUser.email})`)
				...
				// const docRef = docs(db, 'users', 'Uxo3PLXy6deMZZ4nnOXEUYGEZRw2');
				...
				const docRef = docs(db, 'users', currentUser.uid);
